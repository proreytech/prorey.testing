...
* Create PRT S3 Bucket and upload provided PRT packages to `/code` folder, see [Deploy PRT Lambdas package](README.md) and [Deploy PRT Layers](#deploy_prt_layers) sections
